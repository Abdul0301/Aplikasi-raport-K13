        ...
        <footer class="footer">
            <div class="container-fluid">
                <p class="copyright pull-left">
                    <b><?php echo $this->config->item('nama_sekolah'); ?></b> | <a href="https://github.com/Abdul0301" target="_blank">Sumber Asli</a> dikembangkan oleh <a target="_blank" href="http://github.com/Abdul0301/">Abdul Rahman</a> | Disesuaikan untuk SD oleh <a target="_blank" href="https://www.youtube.com/watch?v=JBw4VaSKfYM&t=3s">Abdul Rahman</a> 
                </p>
                <p class="copyright pull-right">
                    Waktu proses {elapsed_time} detik. &copy; 2021 
                </p>
            </div>
        </footer>
